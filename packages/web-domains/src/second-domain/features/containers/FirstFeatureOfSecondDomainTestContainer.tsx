...
export const FirstFeatureOfSecondDomainTestContainer = () => {
  const { displayText, handleChangeDisplayText } = useFirstFeatureOfSecondDomainService();

  return (
    <FirstFeatureOfSecondDomainTestBox displayText={displayText} onClick={handleChangeDisplayText}>
